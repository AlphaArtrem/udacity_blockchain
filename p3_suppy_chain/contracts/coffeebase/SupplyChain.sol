...
contract SupplyChain is Ownable, ConsumerRole, DistributorRole, FarmerRole, RetailerRole{
  ...
  mapping (uint => string[8]) itemsHistory;
  ...
  modifier paidEnough(uint _price) {
    require(msg.value >= _price, "Insufficent Amount Paid");
    _;
  }
  ...
  function getItemHistoryOne(uint _upc) public view returns(
    string memory,
    string memory,
    string memory,
    string memory
  ...
  function getItemHistoryTwo(uint _upc) public view returns(
    string memory,
    string memory,
    string memory,
    string memory
